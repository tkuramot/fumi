...
2. Native Messaging manifest 配置:
   - Chrome: `~/Library/Application Support/Google/Chrome/NativeMessagingHosts/com.tkrmt.fumi.json`
   - 内容:
     ```json
     {
       "name": "com.tkrmt.fumi",
...
| 項目 | OK 条件 |
|---|---|
| manifest 存在 | `com.tkrmt.fumi.json` が配置先に存在 |
...
```
$ fumi doctor
[OK]   Native Messaging manifest: /Users/.../com.tkrmt.fumi.json
